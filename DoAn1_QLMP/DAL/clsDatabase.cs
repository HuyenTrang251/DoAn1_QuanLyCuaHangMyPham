...
namespace DAL
{
    ...
    {
        //protected SqlConnection sql_con = new SqlConnection(@"Data Source=HUYENTRANG\SQLEXPRESS;Initial Catalog=QLMP_NTHT;Integrated Security=True"); //Cô Hà HD

        //Khai báo các đối tượng
        public string strCon = @"Data Source=HUYENTRANG\SQLEXPRESS;Initial Catalog=QLMP_NTHT;Integrated Security=True";
